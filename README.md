...
- `/pycode/`:
  ...
  It also contains two pretrained floating-point models to segment 3 classes (Road, Road Marks and No Drivable) and 5 classes (Road, Road Marks, Vegetation, Sky and Others) which have been trained using v1.0 of HSI-Drive dataset and one pretrained floating-point model to segment the same 5 classes but trained with v2.0 of the dataset.
